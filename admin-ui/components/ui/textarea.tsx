/**
 * Textarea primitive — shadcn/ui shape, Sasai brand tokens. Mirrors
 * input.tsx styling for multi-line fields (review comments, payload edits).
 */
