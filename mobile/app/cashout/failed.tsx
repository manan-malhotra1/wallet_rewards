/**
 * /cashout/failed — cash-out-failed receipt.
 *
 * Red gradient header with an X mark, "Cash-out failed", amount, and agent.
 * A reason callout explains why and reassures "no money has left your
 * account". Cancel returns to /home; Try again pops back to the agent step so
 * the user can re-enter the flow (currency is carried through).
 */
...
/** Failed-cash-out receipt. */
export default function CashOutFailedScreen() {
      ...
      <SafeAreaView style={{ flex: 1 }} edges={['bottom']}>
        <YStack flex={1}>
          ...
          >
            ...
            <YStack flex={1}>
              ...
              <Text
                ...
                lineHeight={18}
              >
                Your cash-out could not be completed. No money has left your account.
              </Text>
            </YStack>
          </XStack>
          ...
          <XStack gap={12} padding={18}>
            ...
            <View flex={1}>
              <ClayButton
                onPress={() => router.replace({ pathname: '/cashout', params: { currency } })}
                height={50}
